...
class FetchParameterValueRepo {
  Dio dio = Dio();
  final url = '${AppConst.baseURL}${AppConst.parameterValueURL}';

  Future<ResponseModel?> fetchParameterValues(BuildContext context) async {
    try {
      final token =
