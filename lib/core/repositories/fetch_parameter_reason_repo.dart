...
class FetchParameterReasonRepo {
  Dio dio = Dio();
  final url = '${AppConst.baseURL}${AppConst.parameterReasonURL}';

  Future<ResponseModel?> fetchParameterReson(BuildContext context) async {
    try {
      final token =
