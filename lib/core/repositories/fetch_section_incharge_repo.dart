...
class FetchSectionInchargeRepo {
  Dio dio = Dio();
  final url = '${AppConst.baseURL}${AppConst.sectionInchargeURL}';

  Future<ResponseModel?> fetchSectionIncharge(BuildContext context) async {
    try {
      final token =
